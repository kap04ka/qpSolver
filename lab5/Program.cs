namespace lab5
{
    public class AlglibDemo
    {
        public static int Main(string[] args)
        {
            ...
            {
                Console.Write(Math.Round(outputData.x[i], 4));
                Console.Write('\t');
            }
        ...
        public static InputData DataSetting()
        {
            int iterCount = 2000;
            ...
            Console.WriteLine(Ab.GetLength(0));
            double[] x0 = { 10.005, 3.033, 6.831, 1.985, 5.093, 4.057, 0.991, 6.667 };


            double[] errors = { 0.200, 0.121, 0.683, 0.040, 0.102, 0.081, 0.020, 0.667 };

            byte[] I = { 1, 1, 1, 1, 1, 1, 1, 1 };

            double[] lb = { 0, 0, 0, 0, 0, 0, 0, 0 };

            double[] ub = { 10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000 };
            Console.WriteLine("Данные заданы");
            return new InputData(Ab, x0, errors, I, lb, ub, iterCount);
        }

        public static double[] Solver(InputData inputData)
        {
            // решение
            double[] x = { };
